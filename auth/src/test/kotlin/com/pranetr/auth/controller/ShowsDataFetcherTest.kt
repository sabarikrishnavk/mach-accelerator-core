...
// */
//
//package com.pranetr.catalog.datafetchers
//
//import com.example.demo.dataloaders.ReviewsDataLoader
//import com.pranetr.catalog.generated.client.AddReviewGraphQLQuery
//import com.pranetr.catalog.generated.client.AddReviewProjectionRoot
//import com.pranetr.catalog.generated.client.ShowsGraphQLQuery
//import com.pranetr.catalog.generated.client.ShowsProjectionRoot
//import com.pranetr.catalog.generated.types.Review
//import com.pranetr.catalog.generated.types.Show
//import com.pranetr.catalog.generated.types.SubmittedReview
...
//    @BeforeEach
//    fun before() {
//        `when`(showsService.shows()).thenAnswer { listOf(
//            com.pranetr.catalog.generated.types.Show(
//                id = 1,
//                title = "mock title",
//                releaseYear = 2020
//            )
...
//                Pair(
//                    1, listOf(
//                        com.pranetr.catalog.generated.types.Review("DGS User", 5, OffsetDateTime.now()),
//                        com.pranetr.catalog.generated.types.Review("DGS User 2", 3, OffsetDateTime.now()),
//                    )
//                )
//            )
//        }
...
//            GraphQLQueryRequest(
//                com.pranetr.catalog.generated.client.ShowsGraphQLQuery.Builder()
//                    .build(),
//                com.pranetr.catalog.generated.client.ShowsProjectionRoot().title()
//            )
...
//                com.pranetr.catalog.generated.client.ShowsGraphQLQuery.Builder()
//                    .build(),
//                com.pranetr.catalog.generated.client.ShowsProjectionRoot()
//                    .title()
//                    .reviews()
//                    .username()
//                    .starScore()
...
//            graphQLQueryRequest.serialize(),
//            "data.shows[*]",
//            object : TypeRef<List<com.pranetr.catalog.generated.types.Show>>() {})
...
//        val graphQLQueryRequest =
//            GraphQLQueryRequest(
//                com.pranetr.catalog.generated.client.AddReviewGraphQLQuery.Builder()
//                    .review(com.pranetr.catalog.generated.types.SubmittedReview(1, "testuser", 5))
//                    .build(),
//                com.pranetr.catalog.generated.client.AddReviewProjectionRoot()
//                    .username()
//                    .starScore()
//            )
//
